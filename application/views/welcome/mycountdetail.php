        ...
        <div class="con">
            ...
            <ul class="n-user-acc-log m-top10">
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-13 16:50:06</h5>
                            <h6 class="f-05 col-7  m-top04">用户充值</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                                1
                            </p>
                            <h6 class="f-05 col-3 text-right m-top04">
                        增加
                    </h6>
                        </div>
                    </div>
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-13 16:48:38</h5>
                            <h6 class="f-05 col-7  m-top04">用户充值</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-13 16:47:07</h5>
                            <h6 class="f-05 col-7  m-top04">用户充值</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-13 14:58:56</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                                0.01
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-10 15:02:54</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-10 14:58:32</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-10 14:57:46</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-10 14:56:33</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-02-10 14:54:58</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-01-10 11:08:15</h5>
                            <h6 class="f-05 col-7  m-top04">用户充值</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                ...
                <li class="dis-shop-list p-r padding-all m-top1px b-color-f  ">
                    <div class="dis-box">
                        <div class="box-flex">
                            <h5 class="f-05 col-7">2017-01-09 20:40:58</h5>
                            <h6 class="f-05 col-7  m-top04">订单支付</h6>
                        </div>
                        <div class="box-flex">
                            <p class="f-05 color-red text-right">
                    ...
                    <li class="box-flex">
                        <div class="page-num">
                            <select name="sel_question" onchange="window.location.href=this.value;">
                                <option value="/app/user/detail?page=1">1/1
                                </option>
                            </select>
                        </div>
                    </li>
