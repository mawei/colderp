		...
		<div class="form-horizontal"  >
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 form-control-static ">
						<?php echo isset($data_info['is_on_big'])?$data_info['is_on_big']:'' ?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 form-control-static ">
						<?php echo isset($data_info['big_price'])?$data_info['big_price']:'' ?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 form-control-static ">
						<?php echo isset($data_info['is_on_small'])?$data_info['is_on_small']:'' ?>
					</div>
				</div>
				<div class="form-group">
					<label for="small_price" class="col-sm-2 control-label form-control-static">价格(个人商户)</label>
					<div class="col-sm-9 form-control-static ">
						<?php echo isset($data_info['small_price'])?$data_info['small_price']:'' ?>
					</div>
				</div>
			</fieldset>
		</div>
