    <footer class="footer-nav dis-box">
        ...
        <a id="link_menu" href="<?=base_url('welcome/categroy')?>" class="box-flex nav-list">
    ...
    <script type="text/javascript" src="<?=base_url('js/jquery.pjax.js')?>"></script>
    <script type="text/javascript" src="<?=base_url('js/nprogress.js')?>"></script>
    <script type="text/javascript" src="j<?=base_url('s/jquery.json.js')?>"></script>
    <script type="text/javascript" src="<?=base_url('js/common.js')?>"></script>
    <script type="text/javascript" src="<?=base_url('js/jquery.more.js')?>"></script>
    <script type="text/javascript" src="<?=base_url('js/utils.js')?>"></script>
    <script type="text/javascript" src="<?=base_url('js/jquery.swiper.min.js')?>"></script>
